...
txt_font = pygame.font.SysFont("Verdana", 20)
...
print("Press F10 to Load")
print("Press F11 to Save")
print("Press F1 for Brush Selection")
    ...
    for event in pygame.event.get():
        ...
        # Save Map
            if event.key == pygame.K_F11:
                name = input("Save Map Name: ")
                export_map("maps\\" + name + ".map")
                print("Map Saved Successfully")

        #Load Map
            elif event.key == pygame.K_F10:
                name = input("Load Map Name: ")
